...
#include "libDevice/DeviceCore.hpp"
...
struct AbstractDevContainer{
    std::shared_ptr<AbstractDevice> newDevice; 
...
class Client{
    private: 
       ...
       // Ticker Mutex; 
        ...
        std::unordered_map<int, AbstractDevContainer> deviceList;     
