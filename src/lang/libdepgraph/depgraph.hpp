    ...
    class DepGraph : public Printer{
        ...
        public: 
            ...
            */ 
            ...
            std::any visit(AstNode::Statement::Expression& ast) override; 
            std::any visit(AstNode::Function::Oblock &ast) override; 
            std::any visit(AstNode::Expression::Binary &ast) override; 
            std::any visit(AstNode::Statement::If& ast) override; 
            std::any visit(AstNode::Statement::For& ast) override; 
            std::any visit(AstNode::Statement::While& ast) override; 
            std::any visit(AstNode::Expression::Group& ast) override; 
            std::any visit(AstNode::Expression::Unary& ast) override;
