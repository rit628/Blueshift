...
namespace BlsLang {
    ...
    GROUP_TEST_F(LexerTest, IdentifierTests, Alphabetic) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "someText", 0, 1, 1, 1, 9),  
        };
    ...
    GROUP_TEST_F(LexerTest, IdentifierTests, Alphanumeric) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "some1Text2", 0, 1, 1, 1, 11),  
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IdentifierTests, LeadingDigit) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "1someText", 0, 1, 1, 1, 10),  
        };
    ...
    GROUP_TEST_F(LexerTest, IdentifierTests, LeadingUnderscore) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "_someText", 0, 1, 1, 1, 10),  
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, IdentifierTests, WhitespaceHandling) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "identifier", 3, 1, 4, 1, 14),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, IntegerLiteral) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "120300", 0, 1, 1, 1, 7),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, NegativeInteger) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::INTEGER, "450600", 1, 1, 2, 1, 8),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, NegativeZero) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::INTEGER, "0", 1, 1, 2, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, HexLiteral) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "0x123456789abcdef", 0, 1, 1, 1, 18),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, HexWithNonHexStartingDigit) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "0xG", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, HexWithNonHexLaterDigits) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "0x12FfH", 0, 1, 1, 1, 8),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, BinaryLiteral) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "0b101101", 0, 1, 1, 1, 9),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, BinaryWithNonBinaryStartingDigit) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "0b2", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, BinaryWithNonBinaryLaterDigits) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "0b1019", 0, 1, 1, 1, 7),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, OctalLiteral) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "001234", 0, 1, 1, 1, 7),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, OctalWithNonOctalStartingDigit) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "09", 0, 1, 1, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, IntegerTests, OctalWithNonOctalLaterDigits) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "01239", 0, 1, 1, 1, 6),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, FloatLiteralSingleIntAndFrac) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "1.2", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, FloatLiteralZeroAndFrac) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "0.2", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, FloatLiteralNoIntAndFrac) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, ".2", 0, 1, 1, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, FloatLiteralMultiDigit) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "10234.56789", 0, 1, 1, 1, 12),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, NegativeDecimal) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::FLOAT, "1.1", 1, 1, 2, 1, 5),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, NegativeDecimalFracOnly) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::FLOAT, ".1", 1, 1, 2, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, ZeroDecimal) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "0.0", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, ZeroDecimalFracOnly) {
        std::string test_str = R"(.0)";
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, ".0", 0, 1, 1, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, NegativeZeroDecimal) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::FLOAT, "0.0", 1, 1, 2, 1, 5),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, NegativeZeroDecimalFracOnly) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::FLOAT, ".0", 1, 1, 2, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, IntegerWithTrailingDecimalPoint) {
        std::string test_str = R"(1.)";
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "1.", 0, 1, 1, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, HexFloat) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "0x123.456", 0, 1, 1, 1, 10),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, BinaryFloat) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "0b1010.101", 0, 1, 1, 1, 11),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, FloatTests, OctalFloat) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "012.34", 0, 1, 1, 1, 7),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, Alphabetic) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"This is a string\"", 0, 1, 1, 1, 19),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, AlphaNumeric) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"This is a 5tring 123\"", 0, 1, 1, 1, 23),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, SpecialCharacters) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"`~!@#$%^&*()-_=+[{]}|;:,<.>/? \"", 0, 1, 1, 1, 33),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, EmptyString) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\"", 0, 1, 1, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, EscapedNestedString) {
        std::string test_str = R"("\"\"")";
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\\\"\\\"\"", 0, 1, 1, 1, 7),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, ActiveBackspace) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\b\"", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, ActiveTab) {
        std::string test_str = "\"\t\"";
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\t\"", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, ActiveFormFeed) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\f\"", 0, 1, 1, 1, 4),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, InvalidEscapeSequences) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\\q\\w\\e\\1\\2\\`\\&\"", 0, 1, 1, 1, 17),
        };
    ...
    GROUP_TEST_F(LexerTest, StringTests, Unterminated) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"unterminated", 0, 1, 1, 1, 14),
        };
        EXPECT_THROW(TEST_LEX(test_str, exp_tokens), SyntaxError);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, UnescapedNestedString) {
        std::string test_str = R"("" "")";
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\"\"\"", 0, 1, 1, 1, 5),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, StringTests, StringLiteralBrokenByCarriageReturn) {
        std::string test_str = "\"\r\"";
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"\r\"", 0, 1, 1, 1, 4),
        };
        EXPECT_THROW(TEST_LEX(test_str, exp_tokens), SyntaxError);
    }
    ...
    GROUP_TEST_F(LexerTest, CommentTests, SingleLineComment) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::COMMENT, "// This is a comment", 0, 1, 1, 1, 21),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, CommentTests, NestedComments) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::COMMENT, "/* Outer /* Inner */", 0, 1, 1, 1, 21),
            Token(Token::Type::IDENTIFIER, "Still", 21, 1, 22, 1, 27),
            Token(Token::Type::IDENTIFIER, "outer", 27, 1, 28, 1, 33),
            Token(Token::Type::OPERATOR, "*", 33, 1, 34, 1, 35),
            Token(Token::Type::OPERATOR, "/", 34, 1, 35, 1, 36),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, CommentTests, NestedCommentsUnclosed) {
        std::string test_str = R"(/* Outer /* Inner Still outer */)";
        std::vector<Token> exp_tokens {
            Token(Token::Type::COMMENT, "/* Outer /* Inner Still outer */", 0, 1, 1, 1, 33),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, OperatorTests, CompoundOperatorEquals) {
        std::string test_str = R"(<=)";
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "<=", 0, 1, 1, 1, 3),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, OperatorTests, MixedCompounds) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "<=", 0, 1, 1, 1, 3),
            Token(Token::Type::OPERATOR, ">=", 2, 1, 3, 1, 5),
            Token(Token::Type::OPERATOR, "!=", 4, 1, 5, 1, 7),
            Token(Token::Type::OPERATOR, "==", 6, 1, 7, 1, 9),
            Token(Token::Type::OPERATOR, "+=", 8, 1, 9, 1, 11),
            Token(Token::Type::OPERATOR, "-=", 10, 1, 11, 1, 13),
            Token(Token::Type::OPERATOR, "*=", 12, 1, 13, 1, 15),
            Token(Token::Type::OPERATOR, "/=", 14, 1, 15, 1, 17),
            Token(Token::Type::OPERATOR, "^=", 16, 1, 17, 1, 19),
            Token(Token::Type::OPERATOR, "%=", 18, 1, 19, 1, 21),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, OperatorTests, FormFeedOperator) {
        std::string test_str = "\f";
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "\f", 0, 1, 1, 1, 2),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, OperatorTests, CarriageReturnOperator) {
        std::string test_str = "\r";
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "\r", 0, 1, 1, 1, 2),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, OperatorTests, BackspaceOperator) {
        std::string test_str = "\b";
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "\b", 0, 1, 1, 1, 2),
        };
        TEST_LEX(test_str, exp_tokens, false);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, MixedWhitespaceAndTokens) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "id1", 2, 1, 3, 1, 6),
            Token(Token::Type::OPERATOR, "+", 6, 1, 7, 1, 8),
            Token(Token::Type::IDENTIFIER, "id2", 12, 2, 4, 2, 7),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, CompoundOperatorsAndIdentifiers) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "id1", 0, 1, 1, 1, 4),
            Token(Token::Type::OPERATOR, "++", 3, 1, 4, 1, 6),
            Token(Token::Type::OPERATOR, ";", 5, 1, 6, 1, 7),
            Token(Token::Type::IDENTIFIER, "id2", 7, 1, 8, 1, 11),
            Token(Token::Type::OPERATOR, "--", 10, 1, 11, 1, 13),
            Token(Token::Type::OPERATOR, ";", 12, 1, 13, 1, 14),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, Expression) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "int", 0, 1, 1, 1, 4),
            Token(Token::Type::IDENTIFIER, "x", 4, 1, 5, 1, 6),
            Token(Token::Type::OPERATOR, "=", 6, 1, 7, 1, 8),
            Token(Token::Type::INTEGER, "5", 8, 1, 9, 1, 10),
            Token(Token::Type::OPERATOR, ";", 9, 1, 10, 1, 11),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, FunctionCall) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "print", 0, 1, 1, 1, 6),
            Token(Token::Type::OPERATOR, "(", 5, 1, 6, 1, 7),
            Token(Token::Type::STRING, "\"Hello, World!\"", 6, 1, 7, 1, 22),
            Token(Token::Type::OPERATOR, ")", 21, 1, 22, 1, 23),
            Token(Token::Type::OPERATOR, ";", 22, 1, 23, 1, 24),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, UnspacedStrings) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::STRING, "\"Hello, World!\"", 0, 1, 1, 1, 16),
            Token(Token::Type::STRING, "\"This is string 2\"", 15, 1, 16, 1, 34),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, SpacedIntegers) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::INTEGER, "15", 0, 1, 1, 1, 3),
            Token(Token::Type::INTEGER, "394", 3, 1, 4, 1, 7),
            Token(Token::Type::FLOAT, "98.81", 7, 1, 8, 1, 13),
            Token(Token::Type::INTEGER, "0", 13, 1, 14, 1, 15),
            Token(Token::Type::INTEGER, "0x9F", 15, 1, 16, 1, 20),
            Token(Token::Type::INTEGER, "0b110", 20, 1, 21, 1, 26),
            Token(Token::Type::INTEGER, "017", 26, 1, 27, 1, 30),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, TrailingNewline) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::IDENTIFIER, "token", 0, 1, 1, 1, 6),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, FloatWithMethodCall) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "1.0", 0, 1, 1, 1, 4),
            Token(Token::Type::OPERATOR, ".", 3, 1, 4, 1, 5),
            Token(Token::Type::IDENTIFIER, "toString", 4, 1, 5, 1, 13),
            Token(Token::Type::OPERATOR, "(", 12, 1, 13, 1, 14),
            Token(Token::Type::OPERATOR, ")", 13, 1, 14, 1, 15),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, NegativeFloatWithMethodCall) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::OPERATOR, "-", 0, 1, 1, 1, 2),
            Token(Token::Type::FLOAT, "1.0", 1, 1, 2, 1, 5),
            Token(Token::Type::OPERATOR, ".", 4, 1, 5, 1, 6),
            Token(Token::Type::IDENTIFIER, "toString", 5, 1, 6, 1, 14),
            Token(Token::Type::OPERATOR, "(", 13, 1, 14, 1, 15),
            Token(Token::Type::OPERATOR, ")", 14, 1, 15, 1, 16),
        };
        TEST_LEX(test_str, exp_tokens);
    }
    ...
    GROUP_TEST_F(LexerTest, ExampleTests, MultipleDots) {
        ...
        std::vector<Token> exp_tokens {
            Token(Token::Type::FLOAT, "1.2", 0, 1, 1, 1, 4),
            Token(Token::Type::FLOAT, ".3", 3, 1, 4, 1, 6),
        };
        TEST_LEX(test_str, exp_tokens);
    }
